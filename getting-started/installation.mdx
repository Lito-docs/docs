---
title: Installation
description: "Install the Lito CLI globally or use npx to start building documentation sites from Markdown in under five minutes"
keywords:
  - install lito
  - lito cli setup
  - documentation tool install
  - npx litodocs
author: Lito Team
