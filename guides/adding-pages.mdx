---
title: Adding Pages
description: "Add and organize documentation pages in Lito with file-system routing, frontmatter metadata, and sidebar configuration in docs-config.json"
keywords:
  - add pages
  - organize docs
...
Lito uses a file-system based routing, but the sidebar navigation is explicitly defined in `docs-config.json`. This gives you full control over the order and hierarchy of your docs.
...
Add metadata to your file. Lito supports extensive frontmatter for SEO and page configuration:
