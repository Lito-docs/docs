---
title: SEO & Meta Tags
description: "Optimize your Lito documentation for search engines with Open Graph tags, Twitter Cards, JSON-LD structured data, and per-page SEO controls"
icon: lucide:search
keywords:
  - seo optimization
  - meta tags
...
Lito includes comprehensive SEO support out of the box, including Open Graph tags, Twitter Cards, JSON-LD structured data, and per-page SEO customization.
...
Lito automatically generates the following meta tags:
...
Lito generates JSON-LD structured data for better search engine understanding:
